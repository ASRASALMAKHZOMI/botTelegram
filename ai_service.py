...
def evaluate_code(challenge, code):
    ...
    قيّم الحل والتزم بالتنسيق التالي حرفيًا وبدون أي Markdown:

    التقييم من 10: X/10
    مستوى الحل: (مبتدئ أو متوسط أو متقدم أو احترافي)
    ...
    messages = [
        {
            "role": "system",
            "content": "أنت مراجع أكواد خبير. التزم بالتنسيق المطلوب بدقة."
        },
        {"role": "user", "content": prompt}
    ]
